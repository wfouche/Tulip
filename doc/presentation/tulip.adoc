...
* TDD - Test driven development (TDD) is a software development process where tests are written before the actual code is written
* LTDD - "Load test driven development"
