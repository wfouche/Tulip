REM jbang io.github.wfouche.tulip:tulip-runtime:2.1.3 Java
...
call jbang run kwrik.kt --rate 10000.0 --threads 2 --duration 20 --repeat 4 --url https://jsonplaceholder.typicode.com/posts/1
@echo off
echo.
