...
jbang --fresh run python_jvm_tulip.java --keep-java report.py
#python3 jython/jython-cli.py report2.py
jbang         run python_jvm_tulip.java --keep-java report2.py
...
jbang run FileModifier.java report2_py.java
